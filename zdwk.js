/*
钻石挖矿            cron 33 2 10,23 * * *  ztzdwk.js
...
class UserClass {
    constructor(ck) {
    	...
    	// 挖矿
        async wk() {
            let sign = MD5Encrypt(`a=wxapp&c=entry&do=index&dopost=make_stone&from=wxapp&i=2&m=skai_tooln&make_power=9&t=0&userid=${this.xr}&v=1.3undefined`)
            let options = {
                fn: 'wk',
                method: 'GET',
                url: `${this.hostname}/app/index.php?i=2&t=0&v=1.3&from=wxapp&c=entry&a=wxapp&do=index&sign=${sign}&m=skai_tooln&dopost=make_stone&userid=${this.xr}&make_power=9`,
