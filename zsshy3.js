/*
钻石挖矿            cron 30 5 9,20 * * *  zsshy3.js

export shy3=" token @ token "  
...
class UserClass {
    constructor(ck) {
		...
		this.qd_headers = {
            ...
            "Referer": "https://servicewechat.com/wx4f8fef107d09e263/7/page-frame.html"
        };
        ...
        async hy() {
            let sign = MD5Encrypt(`a=wxapp&c=entry&do=friend&dopost=all_take_up&from=wxapp&i=2&m=skai_tooln&t=0&userid=5398&id=${this.xr}&type=2&v=1.3undefined`)
            let options = {
                fn: 'hy',
                method: 'GET',
                url: `${this.hostname}/app/index.php?i=2&t=0&v=1.3&from=wxapp&c=entry&a=wxapp&do=friend&sign=${sign}&m=skai_tooln&dopost=take_up&userid=5398&id=${this.xr}&type=2`,
