/*
钻石挖矿            cron 30 5 9,20 * * *  zsshy1.js

export shy1=" token @ token "  
...
class UserClass {
    constructor(ck) {
    	...
    	// shouhaoyou
        async wk() {
            let sign = MD5Encrypt(`a=wxapp&c=entry&do=friend&dopost=all_take_up&from=wxapp&i=2&m=skai_tooln&t=0&userid=5398&id=${this.xr}&type=1&v=1.3undefined`)
            let options = {
                fn: 'wk',
                method: 'GET',
                url: `${this.hostname}/app/index.php?i=2&t=0&v=1.3&from=wxapp&c=entry&a=wxapp&do=friend&sign=${sign}&m=skai_tooln&dopost=take_up&userid=5398&id=${this.xr}&type=1`,
         ...
         if (resp.result == "success") {
             $.log(`${this.idx}: 成功获得好友钻石:${resp.take_up_stone}`)
