...
class UserClass {
    constructor(ck) {
    	...
    	// 挖矿
        async wk() {
            let sign = MD5Encrypt(`a=wxapp&c=entry&do=user&dopost=update_user_offline_stone&from=wxapp&i=2&m=skai_tooln&t=0&userid=${this.xr}&v=1.3undefined`)
            let options = {
                fn: 'wk',
                method: 'GET',
                url: `${this.hostname}/app/index.php?i=2&t=0&v=1.3&from=wxapp&c=entry&a=wxapp&do=user&sign=${sign}&m=skai_tooln&dopost=update_user_offline_stone&userid=${this.xr}`,
