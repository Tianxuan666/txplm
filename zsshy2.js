...
class UserClass {
    constructor(ck) {
    	...
    	// shouhaoyou
        async wk() {
            let sign = MD5Encrypt(`a=wxapp&c=entry&do=friend&dopost=all_take_up&from=wxapp&i=2&m=skai_tooln&t=0&userid=5411&id=${this.xr}&type=1&v=1.3undefined`)
            let options = {
                fn: 'wk',
                method: 'GET',
                url: `${this.hostname}/app/index.php?i=2&t=0&v=1.3&from=wxapp&c=entry&a=wxapp&do=friend&sign=${sign}&m=skai_tooln&dopost=take_up&userid=5411&id=${this.xr}&type=1`,
