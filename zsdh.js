...
class UserClass {
    constructor(ck) {
		...
		this.qd_headers = {
            ...
            "Referer": "https://servicewechat.com/wx4f8fef107d09e263/10/page-frame.html"
        };
        ...
        async wk() {
            ...
            let options = {
                fn: 'wk',
                method: 'GET',
                url: `${this.hostname}/app/index.php?i=2&t=0&v=1.3&from=wxapp&c=entry&a=wxapp&do=exchange&sign=${sign}&m=skai_tooln&dopost=stone_exchange_gold&userid=${this.xr}`,
